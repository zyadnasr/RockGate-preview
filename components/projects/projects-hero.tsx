    ...
    <section className="relative overflow-hidden bg-[#0a0a0a] py-28 text-white md:py-36">
      ...
      <Container className="relative z-10">
        <SectionHeading
          as="h1"
          align="left"
          eyebrow="Portfolio / case-study index"
          title="Selected work"
          highlight="with documented intent."
          description="Every project is a controlled delivery — from first brief to final handover. Browse by category or explore individual case studies."
          dark
        />
      </Container>
    </section>
